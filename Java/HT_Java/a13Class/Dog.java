...
public class Dog {
	 ...
	 * public antea mana class ni evaru chudali ani ardam, private antea privacy.
	 */
	...
	/*
	 * paina breed, height, weight evi mudu bayata real world lo properties but ekada
	   java variables.
	 */
	...
	public static void main(String[] args) {
		...
		/*
		 * manam epudu bayata una variables ni call chaiyali main method lo antea object
		   create chestamu aa object kuda ala create chestamu object name is same as class
		   name.
		 */
